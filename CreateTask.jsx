...
const CreateTask = () => {
    ...
    const submitHandler = (e) => {
      ...
      const data = JSON.parse(localStorage.getItem("data")) || { employees: [] }

data.employees = updatedData
...
>
                ...
                <div className='w-2/5 flex flex-col items-start'>
                    ...
                    <textarea
                        ...
                        className='text-white w-full h-44 text-sm py-2 px-4 rounded outline-none bg-transparent border-2 border-emerald-600'
                    />
